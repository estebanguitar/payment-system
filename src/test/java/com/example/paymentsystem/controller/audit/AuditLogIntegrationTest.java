...
class AuditLogIntegrationTest {
    ...
    void unmappedApiRequestIsAudited() throws Exception {
        ...
        Assertions.assertThat(log.getClientId()).isEqualTo("encrypted");
        Assertions.assertThat(log.getEncryptedPayload()).doesNotContain("integration-client", "private-customer-value");
        Assertions.assertThat(encryptor.decrypt(log.getEncryptedPayload()))
                .contains("integration-client", "private-customer-value");
