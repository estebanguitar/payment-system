...
class OpenApiContractTest {
  ...
  void openApiContainsPresentationEndpoints() throws Exception {
    mockMvc
        ...
        .andExpect(jsonPath("$.paths['/api/v1/ops/audit-logs']").doesNotExist())
        .andExpect(jsonPath("$.paths['/api/v1/ops/reconciliations/runs']").doesNotExist())
        .andExpect(jsonPath("$.paths['/api/v1/ops/reconciliation-breaks']").exists());
  }
}
