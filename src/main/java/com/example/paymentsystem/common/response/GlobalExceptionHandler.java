...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiResponse<ErrorDetail>> handleValidation(BindException exception) {
    ...
    List<ErrorDetail.FieldError> fields =
    ...
    return ResponseEntity.badRequest()
        .body(
            ApiResponse.error(
                ...
                "요청값이 올바르지 않습니다.",
                ErrorDetail.builder().errors(fields).build()));
  }
  ...
  public ResponseEntity<ApiResponse<Void>> handleResourceNotFound(
    ...
    return error(
        HttpStatus.NOT_FOUND, code, ApplicationErrorCode.API_RESOURCE_NOT_FOUND.getMessage());
  }
