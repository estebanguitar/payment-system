package com.example.paymentsystem.repository.outbox;
...
public interface PaymentOutboxRepository extends JpaRepository<PaymentOutbox, Long> {
    ...
    List<PaymentOutbox> findByStatusInAndCreatedAtBeforeOrderByCreatedAtAsc(
            List<OutboxStatus> statuses, LocalDateTime createdBefore, Pageable pageable);
