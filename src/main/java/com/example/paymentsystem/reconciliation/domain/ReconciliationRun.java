...
public class ReconciliationRun {
  ...
  public void complete(long checked, long mismatches, long failures, LocalDateTime now) {
    this.checkedCount = checked;
    this.mismatchCount = mismatches;
    this.failedCount = failures;
    this.completedAt = now;
    this.status = failures == 0 ? RunStatus.COMPLETED : RunStatus.PARTIALLY_FAILED;
  }
