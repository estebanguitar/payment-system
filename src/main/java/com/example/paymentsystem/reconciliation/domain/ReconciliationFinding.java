...
public record ReconciliationFinding(String caseKey, MismatchType type, Severity severity, String customerId, Long walletId, Long paymentId, Long cancelId, Long outboxId, String expectedValue, String actualValue, String evidence) { }
